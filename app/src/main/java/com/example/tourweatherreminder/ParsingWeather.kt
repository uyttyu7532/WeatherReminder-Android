...
//
//
//class MyAsyncTask(context: MainActivity) : AsyncTask<URL, Unit, JSONObject>() {
//
...
//        val json: JSONObject = JSONObject(doc.text())
////        if (isHourly) {
////            parseHourly(json)
////        } else {
////            parseDaily(json)
...
//        if (isHourly) {
//            parseHourly(result)
//            var print = findMinDiffDt(hourlyWeatherArray)
//            Log.i("hourly결과", print.toString())
//        } else {
//            parseDaily(result)
//            var print = findMinDiffDt(dailyWeatherArray)
//            Log.i("hourly결과", print.toString())
//
//        }
//
