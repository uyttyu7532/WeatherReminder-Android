...
//            Log.i("로그",R.string.weather_api_key.toString())
            ...
            var url = URL("https://api.openweathermap.org/data/2.5/onecall?lat=${params[0].latitude}&lon=${params[0].longitude}&&appid=${BuildConfig.API_KEY}&units=metric&exclude=minutely,current")
